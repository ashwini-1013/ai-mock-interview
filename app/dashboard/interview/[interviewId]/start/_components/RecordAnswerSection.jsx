      ...
      >
        {isRecording ? (
          <>
            ...
            <span className='text-red-600 font-semibold flex flex-row gap-2'><StopCircle /> Stop Recording</span>
          </>
        ) : (
          <h2 className='text-primary flex gap-2 items-center'><Mic className='text-primary' />Record Answer</h2>
        )}
      </Button>
